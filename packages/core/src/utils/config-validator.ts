...
export const lodestoneSchema: ConfigSchema = {
  ...
  channels: {
    ...
    properties: {
      telegram: {
        type: "object",
        properties: {
          type: { type: "string", enum: ["telegram"], description: "Channel type identifier" },
          enabled: { type: "boolean", default: false },
          botToken: { type: "string", description: "Telegram bot token from @BotFather" },
          allowFrom: { type: "array", items: { type: "string" } },
          streaming: { type: "boolean", default: true, description: "Enable streaming responses" },
        },
      },
      discord: {
        type: "object",
        properties: {
          type: { type: "string", enum: ["discord"], description: "Channel type identifier" },
          enabled: { type: "boolean", default: false },
      ...
      webchat: {
        type: "object",
        properties: {
          type: { type: "string", enum: ["webchat"], description: "Channel type identifier" },
          enabled: { type: "boolean", default: false },
  ...
  dashboard: {
    ...
    properties: {
      ...
      host: { type: "string", default: "127.0.0.1", description: "Dashboard listen host" },
